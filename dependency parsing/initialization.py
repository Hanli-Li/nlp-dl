...
def xavier_weight_init():
    ...
    def _xavier_initializer(shape, **kwargs):
        ...
        out = tf.Variable(tf.random_uniform(np.array(shape), -epsilon, epsilon))
        return out
...
def test_initialization_basic():
    ...
    """
    print "Running basic tests for initialization..."
    ...
    xavier_mat = xavier_initializer(shape)
    assert xavier_mat.get_shape() == shape
    print "Basic, non-exhaustive Xavier initialization tests passed"
