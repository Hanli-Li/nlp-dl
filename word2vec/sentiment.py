...
def getArguments():
    ...
    group.add_argument("--vectors", dest="vectors", action="store_true",
                       help="Use skipgram/cbow vectors.")
...
def getRegularizationValues():
    ...
    """
    l = []
    values = np.array([0.0001, 0.0003, 0.0005, 0.0007, 0.0009])
    i = 1
    while i <= 100000:
        l.extend(list(values * i))
        i *= 10
    l.append(100)
    return l
...
def main(args):
    ...
    for reg in regValues:
        ...
        # Test on test set, only after validation.
    ...
    if args.pretrained:
        plotRegVsAccuracy(regValues, results, "reg_v_acc.png")
        outputConfusionMatrix(devFeatures, devLabels, bestResult["clf"], "dev_conf.png")
        outputPredictions(devset, devFeatures, devLabels, bestResult["clf"], "dev_pred.txt")
